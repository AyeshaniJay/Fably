...
const refreshTable = () => {
    ...
    fillDataIntoTable(tblProductUsageReport, employees, displayProp, displayDt,
    ...
    for (let index in employees){
        ...
        //     tblProductUsageReport.children[1].children[index].children[5].children[0].style.color = "red";
        //
        // }
        // tblProductUsageReport.children[1].children[index].children[4].children[0].style.display = "none" ;
        // tblProductUsageReport.children[1].children[index].children[4].children[1].style.display = "none" ;
        // tblProductUsageReport.children[1].children[index].children[4].children[2].style.display = "none" ;
    }
...
function btnPrintTable(){
    ...
    let tableHtml = tblProductUsageReport.outerHTML;
...
function generateReport(){
    reportInvoice = getServiceRequest("productusagereport/bysdte?sdte="+dteStartDte.value+"&edte="+dteEndDte.value)

    displayProp = ['product','size','count'];
    displayDt = ['text','text','text'];

    fillDataIntoTable(tblProductUsageReport, reportInvoice, displayProp, displayDt, formReFillData, deleteEmployee, viewEmployee,false,userPrivilege);
